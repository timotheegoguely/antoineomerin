...
<nav class="nav" role="navigation">
  <ul>
    ...
    <li class="nav__item" id="instagram">
      <a href="https://www.instagram.com/<?= $site->find('about')->instagram() ?>" target="_blank" rel="noopener" title="Instagram">
        <svg class="icon icon-instagram" xmlns="http://www.w3.org/2000/svg" fill="none" width="16" height="16" viewBox="0 0 16 16" aria-hidden="true">
